...
import com.timmytruong.dogbreeds.util.PERMISSION_SEND_SMS
...
class MainActivity : AppCompatActivity()
{
    ...
    {
        val activeFragmenet = fragment.childFragmentManager.primaryNavigationFragment

        if (activeFragmenet is DetailFragment)
        {
            (activeFragmenet as DetailFragment).onPermissionResult(permissionGranted)
        }
    }
}